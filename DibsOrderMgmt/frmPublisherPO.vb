...
Public Class frmPublisherPO
    ...
    Public Function AddOrderItems(Optional bAllPartners As Boolean = False, Optional bMissingOrderItems As Boolean = False)
        ...
        LoadOrderItemsInfo(bAllPartners, bMissingOrderItems)
        ...
        For Each oOrderItemRow In oOrderItemsDataTable.Rows
            ...
            Else
                oWorkSheet.Range(sItemQTYCell).Value = oOrderItemRow.Item("QTYMissing").ToString
            End If
...
endUpdate:
    ...
    Private Sub BarButtonItem1_ItemClick(sender As Object, e As XtraBars.ItemClickEventArgs) Handles BarButtonItem1.ItemClick
        ...
        Select Case oOrderDocType
            ...
            Case moDocTypes.PubMissingItems

                sPartner = oPartnerDataTable.Rows(0).Item("PublisherShortName")
                iPartnerID = oPartnerDataTable.Rows(0).Item("PartnerID")

                'Need to add the extension or you can not open it on the other end
                sOrderDocName = sBHPO & "_" & sPartner & "_MissingItems.xlsx"

                sMSG = "You are about 'Save/Replace' the Missing Items: '" & sOrderDocName & "' in the Order Documents. Are you sure you want to continue?"
                sMsgCaption = "Save/Replace Missing Items Doc in Order Documents"
                sOrderDocNotes = "Missing Items Generated by 'The Hive' for Publisher"
    ...
    Private Sub BarButtonItem2_ItemClick(sender As Object, e As XtraBars.ItemClickEventArgs) Handles BarButtonItem2.ItemClick
        ...
        Select Case oOrderDocType
            ...
            Case moDocTypes.PubMissingItems
                ...
                sSubject = "Missing Items for: " & sBHPO & "_" & sPartner
                sBody = "Please see the attached for Missing items: " & sBHPO & "<br>" & "<br>" & "Please let me know if you have any questions." & vbCrLf & vbCrLf
    ...
    Private Sub SpreadsheetCommandBarButtonItem4_ItemClick(sender As Object, e As XtraBars.ItemClickEventArgs) Handles SpreadsheetCommandBarButtonItem4.ItemClick
        ...
        Select Case oOrderDocType
            ...
            Case clsDibsOrderMgmt.OrderDocTypes.PubMissingItems
                sPartner = oPartnerDataTable.Rows(0).Item("PublisherShortName")
                'Need to add the extension or you can not open it on the other end
                sOrderDocName = sBHPO & "_" & sPartner & "_MissingItems.xlsx"
                SpreadsheetControl1.Options.Save.CurrentFileName = sOrderDocName
